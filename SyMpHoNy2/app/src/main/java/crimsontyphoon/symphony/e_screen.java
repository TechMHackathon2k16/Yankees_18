        ...
        Play.setOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        MediaPlayer mp = MediaPlayer.create(e_screen.this, R.raw.e);
                        mp.start();
                        attempt_counter--;
                        attempts.setText(Integer.toString(attempt_counter));
    ...
    public void nextbtn() {
        ...
        n_btn.setOnClickListener(
                new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent intent = new Intent(e_screen.this,end.class);
        ...
        btn5.setOnClickListener(
                new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Toast.makeText(e_screen.this, "The answer is correct. Enter the number in the Number section and press next", Toast.LENGTH_SHORT).show();
        ...
        btn1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(e_screen.this, "The answer is INCORRECT. Proceed to next question by CLICKING NEXT", Toast.LENGTH_SHORT).show();
                btn1.setEnabled(false);
                btn2.setEnabled(false);
                btn3.setEnabled(false);
                btn4.setEnabled(false);
